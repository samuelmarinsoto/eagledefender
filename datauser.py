...
def MailCheck(Mail):
	...
	if isinstance(Mail, str):
		if re.search(r'@', Mail):
			...
			if MailSplit[1] == "gmail.com" or MailSplit[1] == "hotmail.com" or MailSplit[1] == "outlook.com" or \
					MailSplit[1] == "yahoo.com" or MailSplit[1] == "icloud.com" or MailSplit[1] == "live.com":
				mail = Mail
				return 1
			else:
				return 0
